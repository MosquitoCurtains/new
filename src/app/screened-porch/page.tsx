  ...
  return (
    <Container size="xl">
      <Stack gap="lg">
        ...
        {/* Photo Gallery */}
        <HeaderBarSection icon={Camera} label="Screened Porch Gallery" variant="blue">
          <Grid responsiveCols={{ mobile: 2, tablet: 3 }} gap="md">
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  ...
                  alt="21 Mosquito Netting On Screen Porch 1200"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </Frame>
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  ...
                  alt="31 Mosquito Netting On Screen Porch 1200"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </Frame>
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  ...
                  alt="09 Mosquito Netting On Screen Porch 1200"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </Frame>
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  ...
                  alt="32 Mosquito Netting On Screen Porch 1200"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </Frame>
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  ...
                  alt="30 Mosquito Netting On Screen Porch 1200"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </Frame>
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  ...
                  alt="25 Mosquito Netting On Screen Porch 1200"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </Frame>
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  ...
                  alt="23 Mosquito Netting On Screen Porch 1200"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </Frame>
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  ...
                  alt="20 Mosquito Netting On Screen Porch 1200"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </Frame>
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2019/08/02-Mosquito-Netting-on-Screen-Porch-1200-1024x768.jpg"
                  alt="02 Mosquito Netting On Screen Porch 1200"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </Frame>
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  ...
                  alt="01 Mosquito Netting On Screen Porch 1200"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </Frame>
        ...
        <HeaderBarSection icon={Info} label="DIY Installation Has Advantages Beyond Cost Savings" variant="green">
          <TwoColumn gap="lg" className="items-center">
            <Stack gap="md">
              <Text className="text-gray-600">
                You have control and save installation costs. You know how it works and can troubleshoot wind issues.
...
Easily take down & re-hang seasonally, or swap out with our weather enclosure panels.
        ...
        <HeaderBarSection icon={Info} label="Uniquely Different Porch Screen Curtains" variant="green">
          <TwoColumn gap="lg" className="items-center">
            <Stack gap="md">
              <Text className="text-gray-600">
                Think super quality marine-grade mosquito netting bug screen, custom cut to any shape, bound on all sides with a sturdy webbing. You have the option of hanging your curtains using our overhead tracking system or by a fixed Velcro® attachment to save even more. Sides are fastened using stainless steel marine snaps and doorways seal with freakishly strong rare-earth magnets.
