...
import { Container, Stack, Text, Button, Card, Heading, BulletedList, ListItem, FinalCTATemplate, HeaderBarSection, PowerHeaderTemplate } from '@/lib/design-system'
    ...
    <Container size="xl">
      <Stack gap="lg">
        ...
        <div>
          ...
          <PowerHeaderTemplate
            title="4+ Sided Exposure - Irregular Columns With Velcro Top Attachment"
            variant="compact"
            actions={[]}
            trustBadge=""
          />
            ...
            <Stack gap="md">
              ...
              <BulletedList spacing="sm">
                <ListItem variant="arrow" iconColor="#406517">
                  ...
                  <Link href="/plan-screen-porch/4-plus-sided-exposure/screen-a-wrap-around-porch-with-odd-shaped-columns-and-a-tracking-attachment" className="text-[#406517] underline font-medium">Tracking Attachment With Irregular Columns</Link>, or
                </ListItem>
