    ...
    <Container size="xl">
      <Stack gap="lg">
        ...
        <div>
          ...
          <PowerHeaderTemplate
            title="Planning a 4+ Sided Exposure"
          ...
          <Grid responsiveCols={{ mobile: 1, tablet: 2 }} gap="lg">
            <Card variant="elevated" className="!p-6">
              <div className="rounded-xl overflow-hidden mb-4">
                <img src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2021/01/Regular-Columns-1.jpg" alt="Regular columns" className="w-full h-auto" />
              </div>
            ...
            <Card variant="elevated" className="!p-6">
              <div className="rounded-xl overflow-hidden mb-4">
                <img src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2021/01/Irregular-Columns-1.jpg" alt="Irregular columns" className="w-full h-auto" />
              </div>
        ...
        <HeaderBarSection icon={ArrowRight} label="3) Click 1 of 4 Options For Panel Configuration Guidelines" variant="dark">
          ...
          <Grid responsiveCols={{ mobile: 1, tablet: 2 }} gap="lg">
            <Link href="/plan-screen-porch/4-plus-sided-exposure/regular-columns-tracking" className="group">
            ...
            <Link href="/plan-screen-porch/4-plus-sided-exposure/regular-columns-velcro" className="group">
              <Card variant="elevated" className="!p-4 text-center transition-all group-hover:border-[#406517] group-hover:shadow-lg group-hover:-translate-y-1 h-full">
                <div className="rounded-xl overflow-hidden mb-3">
            ...
            <Link href="/plan-screen-porch/4-plus-sided-exposure/screen-a-wrap-around-porch-with-odd-shaped-columns-and-a-tracking-attachment" className="group">
              <Card variant="elevated" className="!p-4 text-center transition-all group-hover:border-[#406517] group-hover:shadow-lg group-hover:-translate-y-1 h-full">
                <div className="rounded-xl overflow-hidden mb-3">
            ...
            <Link href="/plan-screen-porch/4-plus-sided-exposure/irregular-columns-velcro" className="group">
              <Card variant="elevated" className="!p-4 text-center transition-all group-hover:border-[#406517] group-hover:shadow-lg group-hover:-translate-y-1 h-full">
                <div className="rounded-xl overflow-hidden mb-3">
