    ...
    <Container size="xl">
      <Stack gap="lg">
        ...
        <div>
          ...
          <PowerHeaderTemplate
            title="3 Sided Exposure - Irregular Columns With Velcro Top Attachment"
            variant="compact"
            actions={[]}
            trustBadge=""
          />
            ...
            <Stack gap="md">
              ...
              <BulletedList spacing="sm">
                <ListItem variant="arrow" iconColor="#406517">
                  ...
                  <Link href="/plan-screen-porch/3-sided-exposure/irregular-columns-tracking" className="text-[#406517] underline font-medium">Tracking Attachment With Irregular Columns</Link>, or
                </ListItem>
