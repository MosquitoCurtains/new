    ...
    <Container size="xl">
      <Stack gap="lg">
        ...
        <div>
          ...
          <PowerHeaderTemplate
            title="Planning a 3-sided Exposure"
        ...
        <HeaderBarSection icon={ArrowRight} label="3) Click 1 of 4 Options For Panel Configuration Guidelines" variant="dark">
          ...
          <Grid responsiveCols={{ mobile: 1, tablet: 2 }} gap="lg">
            <Link href="/plan-screen-porch/3-sided-exposure/regular-columns-tracking" className="group">
            ...
            <Link href="/plan-screen-porch/3-sided-exposure/regular-columns-velcro" className="group">
              <Card variant="elevated" className="!p-4 text-center transition-all group-hover:border-[#406517] group-hover:shadow-lg group-hover:-translate-y-1 h-full">
                <div className="rounded-xl overflow-hidden mb-3">
            ...
            <Link href="/plan-screen-porch/3-sided-exposure/irregular-columns-tracking" className="group">
              <Card variant="elevated" className="!p-4 text-center transition-all group-hover:border-[#406517] group-hover:shadow-lg group-hover:-translate-y-1 h-full">
                <div className="rounded-xl overflow-hidden mb-3">
            ...
            <Link href="/plan-screen-porch/3-sided-exposure/irregular-columns-velcro" className="group">
              <Card variant="elevated" className="!p-4 text-center transition-all group-hover:border-[#406517] group-hover:shadow-lg group-hover:-translate-y-1 h-full">
                <div className="rounded-xl overflow-hidden mb-3">
