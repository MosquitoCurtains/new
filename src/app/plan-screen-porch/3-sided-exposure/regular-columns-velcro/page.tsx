    ...
    <Container size="xl">
      <Stack gap="lg">
        ...
        <div>
          ...
          <PowerHeaderTemplate
            title="3 Sided Exposure - Regular Columns With Velcro Attachment"
            variant="compact"
            actions={[]}
            trustBadge=""
          />
        ...
        <HeaderBarSection icon={Ruler} label="Measurement Tips" variant="dark">
          <BulletedList spacing="md">
            ...
            <ListItem variant="arrow" iconColor="#406517">We will divide your project into at least 1 panel for each side ending panels at corner columns. Any side can be further split for a magnetic doorway but only if you need one.</ListItem>
            <ListItem variant="arrow" iconColor="#406517">Measure heights at all 4 corners from UNDERSIDE of header beam to floor, since Velcro is side-mounted to some surface.</ListItem>
          ...
          <Text className="text-gray-600 mt-4">
            Watch the video to get an overview on how to measure using{' '}
