    ...
    <Container size="xl">
      <Stack gap="lg">
        ...
        <div>
          ...
          <PowerHeaderTemplate
            title="3 Sided Exposure - Regular Columns With Tracking Top Attachment"
            variant="compact"
            actions={[]}
            trustBadge=""
          />
        ...
        <Card className="!p-6 !bg-white">
          <Stack gap="md">
            <Text className="text-gray-700">
              Unless there is an obstruction or some other compelling reason, we recommend an &quot;outside path&quot; ENDING panels at corner columns. Each of the 3 sides will be split into 2 separate panels (or panel + stucco strip) for a total of 6 panels. If for some reason you must take an inside path, select{' '}
              <Link href="/plan-screen-porch/3-sided-exposure/irregular-columns-tracking" className="text-[#406517] underline font-medium">Irregular Columns With Tracking</Link>.
            </Text>
            <Text className="text-gray-700">
        ...
        <HeaderBarSection icon={Ruler} label="Measurement Tips" variant="dark">
          <BulletedList spacing="md">
            ...
            <ListItem variant="arrow" iconColor="#406517">We then will divide your project into 6 individual panels (for ease of use) that can be split anywhere you choose.</ListItem>
            <ListItem variant="arrow" iconColor="#406517">If for some reason you don&apos;t have a good under-mounting surface, remember you can make one by side-mounting a 2&quot; x 2&quot; wood strip, then under-mounting the track to the wood strip.</ListItem>
            <ListItem variant="arrow" iconColor="#406517">Measure heights at all 4 corners from UNDERSIDE of track mounting surface to floor.</ListItem>
            <ListItem variant="arrow" iconColor="#406517">Measure the &quot;daylight widths&quot; or space BETWEEN house and columns on the 3 sides ALONG the path the curtain will take WITHOUT ANY overlap (we&apos;ll adjust for overlap later). Measure to the 1/2 inch and please be accurate.</ListItem>
          </BulletedList>
          <Text className="text-gray-600 mt-4">
            The configuration diagrams demonstrate examples from a top view using{' '}
            <Link href="/plan-screen-porch/magnetic-doorways" className="text-[#406517] underline font-medium">marine snaps, magnetic doorways, and stucco strips</Link>. Watch the video to get an overview on how to measure and some ideas for your panel configuration.
          </Text>
        </HeaderBarSection>
