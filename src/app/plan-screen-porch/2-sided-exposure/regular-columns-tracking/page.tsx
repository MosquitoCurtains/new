    ...
    <Container size="xl">
      <Stack gap="lg">
        ...
        <div>
          ...
          <PowerHeaderTemplate
            title="2 Sided Exposure - Regular Columns With Tracking Top Attachment"
            variant="compact"
            actions={[]}
            trustBadge=""
          />
        ...
        <Card className="!p-6 !bg-white">
          <Stack gap="md">
            <Text className="text-gray-700">
              Unless there is an obstruction or some other compelling reason, we recommend an &quot;outside path&quot; ENDING panels at corner columns. Each of the 2 sides will be split into 2 separate panels (or panel + stucco strip) for a total of 4 panels. If for some reason you must take an inside path, select{' '}
              <Link href="/plan-screen-porch/2-sided-exposure/irregular-columns-tracking" className="text-[#406517] underline font-medium">Irregular Columns With Tracking</Link>.
            </Text>
            <Text className="text-gray-700">
        ...
        <HeaderBarSection icon={Ruler} label="Measurement Tips" variant="dark">
          <BulletedList spacing="md">
            ...
            <ListItem variant="arrow" iconColor="#406517">We then will divide your project into 4 individual panels (for ease of use) that can be split anywhere you choose.</ListItem>
            ...
            <ListItem variant="arrow" iconColor="#406517">Measure heights at all 3 corners from UNDERSIDE of track mounting surface to floor.</ListItem>
            <ListItem variant="arrow" iconColor="#406517">Measure the &quot;daylight widths&quot; or space BETWEEN house and columns on the 2 sides ALONG the path the curtain will take WITHOUT ANY overlap (we&apos;ll adjust for overlap later). Measure to the 1/2 inch and please be accurate.</ListItem>
          </BulletedList>
