  ...
  return (
    <Container size="xl">
      <Stack gap="lg">
        ...
        {/* Photo Gallery */}
        <HeaderBarSection icon={Camera} label="Weather Curtains Gallery" variant="blue">
        ...
        <HeaderBarSection icon={Info} label="Plastic Weather Curtains Interchangeable With Our Summer Mosquito Curtains" variant="green">
          <TwoColumn gap="lg" className="items-center">
            <Stack gap="md">
              <Text className="text-gray-600">
            ...
            <Frame ratio="4/3" className="rounded-lg overflow-hidden">
              <img
                src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2021/06/Interchangeable-Mosquito-Curtain-Clear-Vinyl-3-768x576.jpg"
                alt="Plastic Weather Curtains Interchangeable With Our Summer Mosquito Curtains"
                className="w-full h-full object-cover"
                loading="lazy"
              />
            </Frame>
        ...
        <HeaderBarSection icon={Info} label="Plastic Enclosure Curtains For Patio" variant="dark">
          <Stack gap="md">
              <Text className="text-gray-600">Protect your porch or patio from old wind, rain, snow or spring pollen with custom-made Clear Vinyl Plastic Weather Curtain Enclosures. Used in conjunction with a space heater, our plastic porch enclosures will create a cozy outdoor space while protecting your porch from the damaging elements. Weatherproof your Patio Today!</Text>
          </Stack>
        </HeaderBarSection>
        <HeaderBarSection icon={Info} label="All Weather Porch Enclosure Curtains For Existing Screened Porch" variant="dark">
          <Stack gap="md">
