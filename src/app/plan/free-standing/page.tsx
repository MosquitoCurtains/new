        ...
        <section className="relative py-8 text-center">
          <Stack gap="md" className="max-w-3xl mx-auto">
            <div className="w-16 h-16 bg-[#406517]/10 rounded-full mx-auto flex items-center justify-center">
              <TreePine className="w-8 h-8 text-[#406517]" />
            </div>
            <Heading level={1} className="!text-4xl md:!text-5xl">
              Planning Free Standing Structures
            </Heading>
          </Stack>
        </section>
          ...
          <Stack gap="md">
            ...
            <AccordionSection title="Awnings">
              <Stack gap="md">
                ...
                <Frame ratio="16/9" className="rounded-xl overflow-hidden max-w-md">
                  <img src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2020/03/Skip-Two-Steps-Menu-Image.png" alt="Skip Two Steps" className="w-full h-full object-contain bg-white" />
                </Frame>
            ...
            <AccordionSection title="Pergolas / Open Top Structures">
              <Stack gap="md">
                ...
                <Frame ratio="16/9" className="rounded-xl overflow-hidden max-w-md">
                  <img src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2020/03/Skip-One-Step-Menu-Image.png" alt="Skip One Step" className="w-full h-full object-contain bg-white" />
                </Frame>
              ...
              <Stack gap="md">
                ...
                <Grid responsiveCols={{ mobile: 1, tablet: 2 }} gap="lg">
                  ...
                  <Frame ratio="4/3" className="rounded-xl overflow-hidden">
                    <img src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2019/08/17-Mosquito-Netting-on-Gazebo-1200.jpg" alt="Mosquito netting on gazebo" className="w-full h-full object-cover" />
                  </Frame>
                </Grid>
                <BulletedList spacing="sm">
