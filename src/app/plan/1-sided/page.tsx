      ...
      <Stack gap="lg">
        ...
        <section className="relative py-8 text-center">
          <Stack gap="md" className="max-w-3xl mx-auto">
            ...
            <Text className="text-xl text-gray-600">
              This is the easiest of all applications that we often call the &quot;straight shot&quot; because your exposure turns no corners. Generally, the project is divided into 2 panels that come together to form a magnetic doorway so that you can enter easily.
            </Text>
          </Stack>
        </section>
        ...
        <HeaderBarSection icon={Square} label="Possible Panel Configurations" variant="dark">
          <Text className="text-gray-600 mb-6">
            ...
            <Link href="/plan/magnetic-doorways" className="text-[#406517] underline font-medium">
