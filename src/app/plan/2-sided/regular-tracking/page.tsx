        ...
        <section className="relative py-8 text-center">
          <Stack gap="md" className="max-w-3xl mx-auto">
            ...
            <Heading level={1} className="!text-3xl md:!text-4xl">
              2 Sided Exposure - Regular Columns With Tracking Top Attachment
            </Heading>
          </Stack>
        </section>
        ...
        <Card className="!p-6 !bg-white">
          <Stack gap="md">
            <Text className="text-gray-700">
              ...
              <Link href="/plan/2-sided/irregular-tracking" className="text-[#406517] underline font-medium">Irregular Columns With Tracking</Link>.
            </Text>
            <Text className="text-gray-700">
