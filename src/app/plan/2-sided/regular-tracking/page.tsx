  ...
  return (
    <Container size="xl">
      <Stack gap="lg">
          ...
          <Grid responsiveCols={{ mobile: 1, tablet: 2 }} gap="lg" className="items-center">
            ...
            <Stack gap="md">
              <Text className="text-gray-600">
                ...
                your 2-sided regular tracking project for the best results.
              </Text>
              <BulletedList spacing="md">
                <ListItem variant="checked" iconColor="#406517">How to measure each opening</ListItem>
                <ListItem variant="checked" iconColor="#406517">Planning your layout</ListItem>
                <ListItem variant="checked" iconColor="#406517">Choosing doorway locations</ListItem>
              </BulletedList>
            </Stack>
          </Grid>
        </HeaderBarSection>
        ...
        {/* Photo Gallery */}
        <HeaderBarSection icon={Camera} label="2-Sided Regular Tracking Gallery" variant="blue">
          <Grid responsiveCols={{ mobile: 2, tablet: 3 }} gap="md">
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2021/01/2-Sided-Regular-Columns-Track-1-768x576.jpg"
                  alt="2-Sided Regular Tracking"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </Frame>
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2021/01/4-Panel-Regular-2-Sided-768x576.png"
                  alt="2-Sided Regular Tracking"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2021/01/4-Panel-Regular-2-Sided-1-768x576.png"
                  alt="2-Sided Regular Tracking"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
            ...
            <Card className="!p-0 overflow-hidden">
              <Frame ratio="4/3" className="rounded-lg overflow-hidden">
                <img
                  src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2021/01/3-Panels-Stucco-Strip-768x576.png"
                  alt="2-Sided Regular Tracking"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
        ...
        <HeaderBarSection icon={Info} label="2 Sided Exposure - Regular Columns With Tracking Top Attachment" variant="green">
          <TwoColumn gap="lg" className="items-center">
            <Stack gap="md">
              <Text className="text-gray-600">
                Unless there is an obstruction or some other compelling reason, we recommend an “outside path” ENDING panels at corner columns. Each of the 2 sides will be split into 2 separate panels (or panel + stucco strip) for a total of 4 panels. If for some reason you must take an inside path, select Irregular Columns With Tracking.
...
Panel Configuration Example
            ...
            <Frame ratio="4/3" className="rounded-lg overflow-hidden">
              <img
                src="https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2021/01/2-Sided-Regular-Columns-Track-1-768x576.jpg"
                alt="2 Sided Exposure - Regular Columns With Tracking Top Attachment"
                className="w-full h-full object-cover"
                loading="lazy"
              />
            </Frame>
