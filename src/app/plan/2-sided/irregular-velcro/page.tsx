        ...
        <section className="relative py-8 text-center">
          <Stack gap="md" className="max-w-3xl mx-auto">
            ...
            <Heading level={1} className="!text-3xl md:!text-4xl">
              2 Sided Exposure - Irregular Columns With Velcro Top Attachment
            </Heading>
          </Stack>
        </section>
            ...
            <Stack gap="md">
              ...
              <BulletedList spacing="sm">
                <ListItem variant="arrow" iconColor="#406517">
                  ...
                  <Link href="/plan/2-sided/irregular-tracking" className="text-[#406517] underline font-medium">Tracking Attachment With Irregular Columns</Link>, or
                </ListItem>
