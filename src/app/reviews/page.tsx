...
import { FinalCTATemplate, PowerHeaderTemplate } from '@/lib/design-system/templates'
import { ORDERS_SERVED_FORMATTED, ORDERS_SERVED_COUNT } from '@/lib/constants/orders-served'

// Base URL for review images (crawled from WordPress /mosquito-curtains-reviews/) - use full-size, no thumbnail suffix
const IMG = (path: string) =>
  `https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/${path}`

// All reviews from WordPress HTML crawl - order, titles, quotes, attributions, images (full-size URLs)
const REVIEWS: Array<{
  title: string
  quote: string
  author?: string
...
}> = [
  {
    ...
    images: [IMG('2019/08/00-Mosquito-Netting-Various-Projects-1200.jpg')],
  },
  {
    title: 'Ordered from Israel',
    quote:
      'Amazing company, nothing too much bother to help. Quality of product is the highest, and workmanship the best. Ordered from Israel, arrived and fits perfectly. Cannot speak highly enough of this company and would recommend them to anyone wanting the best. Also purchased their netting screens as well, same quality and workmanship.',
    author: 'Julian Cohen, Israel',
    images: [IMG('2020/05/Clear-Vinyl-Israel-Project-for-Website.jpg')],
  },
  {
    title: 'Enjoying the Back Porch Again',
    quote:
      'Customer Service was great from the beginning, from initial questions, to measuring, ordering and fast shipping. We followed the video on installation and hanging the first one was a learning experience but the rest were a breeze. They look amazing and most importantly I can enjoy my back porch again! I am very allergic to insects and in Texas they are a very hard thing to dodge so these curtains have helped us reclaim our back patio area! (We did add some light weights to the bottom to keep them from swaying in the wind.) Love that I can easily open and close these, depending on our need and the weather. Highly recommend to everyone –thank you Mosquito Curtains!',
  },
  {
    title: 'American Farmhouse',
    quote:
      'We have an old farm house with a nice front porch, but for a couple months every summer we couldn\'t enjoy it because of the mosquitos. This spring we ordered our curtains from you, they are everything you advertised. The installation was easy, and we have had dinner on the porch more times already this year then ever before. I have told all of our friends about your product and your family run business.',
    author: 'Walt and Karen, Michigan',
    images: [IMG('2019/08/Mosquito-Curtains-American-Porch.jpg')],
  },
  {
    title: 'Hail Storm',
    quote:
    ...
    images: [IMG('2019/08/Hail-Protection-Net.jpg')],
  },
  {
    title: '"Air Traffic Control" Odd Shaped Panels (See Outer Corners)',
    quote:
      'Hi Kurt. The mosquito curtain is in and looks great!!! Installation was actually quite easy. Thanks again for your quick response….We are thoroughly enjoying the space. We have not had dinner in the house since it was installed.',
    author: 'Michael T.',
    note: 'The awning top takes a path 14" outside the railing. The panels are slanted in and hang on the inside of the railing. These cuts are very unusual to make this look like slanted windows similar to an air traffic control tower.',
    images: [IMG('2019/08/Odd-Shaped-Awning-2.jpg'), IMG('2019/08/Odd-Shaped-Awning-1.jpg')],
  },
  {
    title: 'Clear Vinyl',
    quote:
  ...
  },
  {
    ...
    images: [IMG('2019/08/Insect-Curtains.jpg')],
  },
  {
    title: 'A Warm Football Season',
    quote:
      'The installation was easy. I have an upright propane heater on the porch which we used to have to run on high when it is cold, now with the curtains up it has yet to go past low.',
    images: [IMG('2019/08/Plastic-Window-Curtains-1.jpg'), IMG('2019/08/Plastic-Window-Curtains-2.jpg')],
  },
  {
    title: 'Smokin Happy',
    quote:
      'Sorry it has taken me so long to let you know how the job came out. Suffice it to say, I am extremely happy with the outcome. All the adjustments came out just as I wished, and the curtains are performing as advertised. I am really impressed with the magnetic closure system. It works perfectly. The dog learned how to use them in the first hour… Thanks so much for all your efforts. You guys really have the process down. You can list me as a happy customer.',
    author: 'Best Regards –Bill, Houston',
    images: [IMG('2019/08/Insect-Screen-1.jpg'), IMG('2019/08/Insect-Screen-2.jpg')],
  },
  {
    title: 'A Gift From One Good Friend To Another',
    quote:
      'Thank you so much for helping me on this project for my good friends, it really came out excellent everyone was impressed by the quality and the neatness of the curtains. My friends were very grateful!',
    author: 'Essam',
    images: [IMG('2019/08/Ivory-Black-1.jpg'), IMG('2019/08/Ivory-Black-2.jpg')],
  },
  {
    title: 'Happy Couple',
    quote:
      'The curtains turned out great. They are well-made and beautiful. Your website videos answered every question. Installation was easy. You were wonderful to deal with. Last evening, my wife and I sat out on our porch.  Our grandson stopped by for a minute and stood outside the screens just to say "Hello." Mosquitos immediately swarmed around him… We sat on the porch without seeing a single mosquito… NOT ONE made it through the curtains… Thank you for an excellent product and being a company that DELIVERS on its promises.',
    author: 'Bill Wausau, Wisconsin',
    images: [IMG('2019/08/Screen-Porch-1.jpg'), IMG('2019/08/Screen-Porch-2.jpg')],
  },
  {
    title: 'A Canadian Porch',
    quote:
    ...
    images: [IMG('2019/08/Screen-Patio-1.jpg'), IMG('2019/08/Screen-Patio-2.jpg')],
  },
  {
    title: 'Just Pretty Photos',
    quote:
    ...
    images: [IMG('2019/08/White-Porch-Curtains-1.jpg'), IMG('2019/08/White-Porch-Curtains-2.jpg')],
  },
  {
    title: 'Awesome',
    quote:
      'Here are some shots of our awesome mosquito curtain. You can see the corner column and the different height ceilings that was so difficult.  You all did a great job helping and I am so appreciative. I have already had several people ask me where I got them.',
    images: [IMG('2019/08/135-Corner-Awning-Curtains.jpg'), IMG('2019/08/135-Corner-Awning-Curtains-2.jpg')],
  },
  {
    title: 'Service',
    quote:
      'We like the screens very much and have shown them to neighbors and friends. We have struggled with the decision of screening in our porch because we like the openness and our view. By choosing the Mosquito Curtains we are enjoying the best of both worlds. Thanks for your help. Support after the sale was just as important as being satisfied with the curtains. We would recommend the curtains to others.',
    images: [IMG('2019/08/Patio-Curtains-1.jpg'), IMG('2019/08/Patio-Curtains-2.jpg')],
  },
  {
    title: 'Mosquito NO Vacancy',
    quote:
      'Thanks for all of your help on this Arron. As you can see it turned out pretty damn nice. Very happy with the curtain and now the Mosquitos will have to find somewhere else to go. Lol. Thanks again.',
    author: 'Thane',
    images: [IMG('2019/08/Outdoor-Curtains-1.jpg'), IMG('2019/08/Outdoor-Curtains-2.jpg')],
  },
  {
    title: 'A Life Saver (Navy SEAL)',
    quote:
    ...
    note: 'We played with various curtain meshes and made double ply curtains that had qualities that would enable him to see out but would block the visibility into his concealment position. We donated curtains to this particular soldier as we didn\'t want his safety to depend on one minute of procurement bureaucracy. This was his response: "Hey Kurt, sorry i am so late in replying to you. I have been in Iraq for about a month re-enlisting. Your stuff was amazing, I cant talk enough about it. I\'m sure it probably saved my skin a few times to0. We had people so close to the hide site that I was sure that we were busted but they never saw us. The stuff worked great also, I was able to try all the methods of attachment that we spoke about and they all worked great.  The magnets worked every time I needed them to and so did the screw in buttons. It was great, I got into some trouble on one occasion and had to leave in a real hurry. I happened to be using the magnets at the time and it was awesome. I just grabbed and yanked and I was gone in 2 minutes.  Fabulous. I shot through it on a number of occasions and it didn\'t affect the bullet flight in any way what so ever. I loved the stuff.  If you want to get ahold of me again, then just email me back whenever you want to, I\'ll try and be more prompt about replying. Thanks again Kurt, your stuff was a real lifesaver (literally). Sincerely, XXXXXXX"',
  },
  {
    title: 'Worth Every Penny',
    quote:
      'I want to let you know that we love our curtains. This is the first year that we actually sat outside in our backyard and were not bitten to death by mosquitoes. Thanks to our beautiful curtains!!! They not only do the job of keeping the nasty mosquitoes out but also look beautiful. There are certain things we spend our money on and say to ourselves, "that was not worth it", but with the mosquito curtains, "WORTH EVERY PENNY"',
  },
  {
    title: 'Superb',
    quote:
  ...
  {
    title: 'Sarcastically Satisfied (funny)',
    quote:
  ...
  },
  {
    ...
    images: [IMG('2019/08/Rain-Proof.jpg')],
  },
  {
    title: 'Orchid Grower',
    quote:
      'I have the vinyl curtains up and they look great, and fit also. I could not be more pleased. Thanks for all of your help on my order.',
    images: [IMG('2019/08/Clear-Vinyl-Pool-Enclosure.jpg')],
  },
  {
    title: 'Creative Lady',
    quote:
    ...
    images: [IMG('2019/08/Mosquito-Netting-Pergola.jpg')],
  },
  {
    title: 'Passing It On',
    quote:
      'Hi Steve, finally got the curtains up and absolutely love them!!! Had lots of compliments and passed on your name! Thank you for the great service!',
    author: 'Russell and Andrea',
    images: [IMG('2019/08/Porch-Screened.jpg')],
  },
  {
    title: 'USDA Bee Study',
    quote:
    ...
    author: 'Yours, Jim C. USDA-ARS Utah',
    images: [IMG('2019/08/Bee-Enclosure.jpg')],
  },
  {
    title: 'Great Doing Business With You',
    quote:
      'Hi Steve, I finished up my curtain install and was able to enjoy it on both days this past weekend. The product arrived promptly and was exactly as we had discussed. I am hoping to have many years of added enjoyment as a result of this investment. I already have a neighbor interested and will be forwarding your contact information if he wants to move forward. Attached are a few pictures of the finished product. Hope to see them up on your website. Glad to promote your product. Once again it was great doing business with you and I will certainly promote your product.',
    author: 'Regards, Kevin M.',
    images: [IMG('2019/08/Outdoor-Screens.jpg')],
  },
  {
    title: 'Mahalo from Maui!',
    quote:
      'Dear Mosquito Curtains, Our little curtain turned out great, thank you so much! It\'s been so nice to enjoy the view without the unwanted company of mosquitos! Thought you might find this idea interesting for the bottom edge, we are going to try velcro-ing little sandbags to the bottom edge of the curtain (a boat-cover trick).  If it still needs elastic cords in the corner, we\'ll install the hooks in the floor, after the deck is tiled.',
    author: 'Amy & David.',
    images: [IMG('2019/08/Hawaii-Porch-Screen.jpg')],
  },
  {
    title: 'Great Product',
    quote:
      'Steve, Could not be happier! What a great product. Top quality materials, superior customer service and simple homeowner installation. Thanks for all your guidance and help.',
    author: 'Jim',
    images: [IMG('2019/08/Shade-Fabric-Porch.jpg')],
  },
  {
    title: 'Extremely Impressed',
    quote:
      'Hi Kurt, I know I\'m pretty late getting these to you, but I figured better late than never! I got everything installed, and I\'ve used them a few times. I\'m extremely impressed! They make a world of difference when the mosquitos start to come out in the evening! I can actually use the porch after the sun goes down now!',
    author: 'Jason',
    images: [IMG('2019/08/Mosquito-Netting.jpg')],
  },
  {
    title: 'Very Happy After 5 Years',
    quote:
      'Our 5th season of use. Your wonderful service and quality of product has transformed our deck into the favorite room at the cottage. So simple but so awesome. Open and close the screens in under one minute. We have extreme weather conditions here on the Northumberland Strait / west side of Prince Edward Island, Canada. Your screens still look like new in spite of strong winds carrying salt and sand spray continually. Feel free to use this as a testimonial. Many Thanks.',
    author: 'Eric',
    images: [IMG('2019/08/Canadian-Porch.jpg')],
  },
]
...
export default function ReviewsPage() {
  return (
    <Container size="xl">
      <Stack gap="xl">
        {/* Hero - compact: title + intro text left, video right */}
        <PowerHeaderTemplate
          title="Mosquito Curtains Reviews"
          subtitle="Making our customers happy is our goal. We often receive photos of our work from our satisfied customers once they finish installation. We proudly display them here on our website. Read below to see what our customers have to say and how they describe their experiences with us. We would love to work with you too!"
          variant="compact"
          videoId={VIDEOS.CUSTOM_NETTING}
          videoTitle="100 Projects in 50 Seconds"
          actions={[]}
          trustBadge=""
        />
        ...
        {/* All customer reviews - 3/4 + 1/4 (one image) or 1/2 + 1/4 + 1/4 (two images) */}
        <section>
          <Heading level={2} className="text-center !mb-8">Reviews</Heading>
          <Stack gap="lg">
            {REVIEWS.map((review, idx) => {
              const hasImages = review.images && review.images.length > 0
              const oneImage = hasImages && review.images!.length === 1
              const twoImages = hasImages && review.images!.length >= 2
              return (
                <Card key={idx} variant="elevated" className="!p-6">
                  ...
                  >
                    {/* Left: header + text — 3/4 if one image, 1/2 if two images */}
                    <div
                      className={
                        !hasImages
                          ? ''
                          : oneImage
                            ? 'md:col-span-3 min-w-0'
                    ...
                    >
                      ...
                      <blockquote className="text-gray-600 italic mb-3 border-l-4 border-[#406517] pl-4 text-sm md:text-base">
                      ...
                      {review.note && (
                        <p className="text-sm text-gray-500 italic">{review.note}</p>
                      )}
                    </div>
                    {/* Right: image(s) — 1/4 each, constrained so not massive */}
                    {hasImages && (
                      <div
                        className={
                          oneImage
                            ? 'md:col-span-1 grid grid-cols-1'
                            : 'md:col-span-2 grid grid-cols-2 gap-3'
                        }
                      >
                        {review.images!.map((src, i) => (
                          <div
                            key={i}
                            className="rounded-xl overflow-hidden aspect-[4/3] w-full max-w-[240px] md:max-w-none mx-auto md:mx-0"
                          >
                            <img
                              src={src}
                              alt=""
