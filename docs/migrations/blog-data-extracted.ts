// Blog post data - extracted from WordPress via Cheerio
// Generated: 2026-02-11T18:57:53.773Z
...
export const BLOG_POSTS: BlogPost[] = [
  {
    slug: 'gazebos-then-and-now',
    title: 'Gazebos: Then and Now - Mosquito Curtains',
    excerpt: 'For thousands of years, gazebos have provided shade and shelter for those of us who enjoy the peace and solitude nature has to offer. We see them in town squares, in beautiful gardens, and on the bank',
...
`,
    image: 'https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2019/08/17-Mosquito-Netting-on-Gazebo-400.jpg',
    date: '2019-10-25',
    category: 'Uncategorized',
  },
  {
    slug: 'how-to-cope-with-pollen-in-porches-and-gazebos',
    title: 'How to Cope With Pollen in Porches and Gazebos - Mosquito Curtains',
    excerpt: 'Do you, like me, come home every day to insane amounts of pollen, covering your picnic table or outdoor space? Spring is just starting and I want to enjoy my patio every day, but my kids have such bad',
    content: `Do you, like me, come home every day to insane amounts of pollen, covering your picnic table or outdoor space? Spring is just starting and I want to enjoy my patio every day, but my kids have such bad allergic reactions to ragweed that I can’t just leave the pollen there to blow away on its own. So I feel like I’m constantly cleaning. True, it’s the season for spring cleaning, but there there has to be a better way to protect against the constant dust and irritants floating around my outdoor space!
...
`,
    image: 'https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2019/08/01-Pollen-Protection-400.jpg',
    date: '2019-10-25',
    category: 'Uncategorized',
  },
  {
    slug: 'mosquito-enclosures-for-decks',
    title: 'Mosquito Enclosures For Decks - Mosquito Curtains',
    excerpt: 'If biting insects are keeping you from enjoying your deck, consider these solutions available to you. We want to help you navigate these alternatives so that you don’t waste your money on poor quality',
    content: `If biting insects are keeping you from enjoying your deck, consider these solutions available to you. We want to help you navigate these alternatives so that you don’t waste your money on poor quality products.
...
`,
  ...
  {
    slug: 'where-is-the-mosquito-capitol',
    title: 'Where Is The Mosquito Capitol? - Mosquito Curtains',
    excerpt: 'Why Do Mosquitoes Seem More Intense In Northern Climates?',
    content: `Why Do Mosquitoes Seem More Intense In Northern Climates?
...
`,
    image: 'https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2019/10/047-White-Mosquito-Netting-Curtains-400.jpg',
    date: '2019-10-25',
    category: 'Uncategorized',
  },
  {
    slug: 'is-your-porch-too-beautiful-to-screen',
    title: 'Is Your Porch Too Beautiful To Screen? - Mosquito Curtains',
    excerpt: 'Take a walk down the streets of any historic neighborhood and it is easy to see the allure of a grand old porch. Each genre of architecture has its own unique way of celebrating this inviting sanctuar',
    content: `Take a walk down the streets of any historic neighborhood and it is easy to see the allure of a grand old porch. Each genre of architecture has its own unique way of celebrating this inviting sanctuary that links the home with the surroundings of outdoor life. Sadly, a charming porch will often remain vacant during mosquito season as homeowners are reluctant to destroy its lovely character with permanent screening.
...
`,
    image: 'https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2019/10/003-White-Mosquito-Netting-Curtains-400.jpg',
    date: '2019-10-25',
    category: 'Uncategorized',
  },
  {
    slug: 'finally-a-new-storm-proof-screening',
    title: 'Finally, A New Storm Proof Screening? - Mosquito Curtains',
    excerpt: 'As the storm season has finally passed, many Floridians are reluctant to spend thousands of dollars replacing screen enclosures that have taken a pounding. In the attempt to regain normalcy, many are ',
    content: `As the storm season has finally passed, many Floridians are reluctant to spend thousands of dollars replacing screen enclosures that have taken a pounding. In the attempt to regain normalcy, many are finding it difficult to find professionals to replace damaged screens as contractors focus on, the more lucrative, new installations. Frustrated, many home owners are turning to Mosquito Curtains as an alternative to permanent screening.
...
The company’s website, mosquitocurtains.kinsta.cloud has shipped more than 29,000 orders to customers in the United States and abroad. Mosquito Curtains appeal to both owners of upscale residences who appreciate its pleasing aesthetics, and budgeted home owners who appreciate an 80% cost savings compared to a professionally installed framed screen.
...
`,
  ...
  {
    slug: 'why-do-mosquitoes-seem-more-intense-in-northern-climates',
    title: 'Why Do Mosquitoes Seem More Intense In Northern Climates? - Mosquito Curtains',
    excerpt: 'If you’ve ever heard that whirring high pitched whine of a mosquito, you know just how aggrevating they can be. Many of our clients claimed that they lived in the mosquito capital of the world… so we ',
    content: `If you’ve ever heard that whirring high pitched whine of a mosquito, you know just how aggrevating they can be. Many of our clients claimed that they lived in the mosquito capital of the world… so we did a little research.
...
`,
  ...
  {
    slug: 'air-lines-explore-screen-doors-on-aircraft',
    title: 'Air Lines Explore Screen Doors On Aircraft - Mosquito Curtains',
    excerpt: 'A little known fact to many fliers is that certain countries require that aircraft cabins be sprayed with pesticides between flights. Most of the time the spraying is done just prior to boarding, howe',
    content: `A little known fact to many fliers is that certain countries require that aircraft cabins be sprayed with pesticides between flights. Most of the time the spraying is done just prior to boarding, however don’t be surprised if a flight attendant walks down the aisle waving a can of aerosol while you are already seated. While the airlines make every effort to use safe products, patrons and crews understandably bristle at the thought of pesticide exposure and health officials are looking for an alternative solution.
...
`,
  ...
  {
    slug: 'a-new-mulligan-blocker-for-golf-course-residents',
    title: 'A New Mulligan Blocker For Golf Course Residents - Mosquito Curtains',
    excerpt: '“I live on the 17th fairway of an Ohio country club and am tired of replacing my torn porch screening every other season because of errant golfers. I’d rip the whole thing out, but then, golf balls wo',
    content: `“I live on the 17th fairway of an Ohio country club and am tired of replacing my torn porch screening every other season because of errant golfers. I’d rip the whole thing out, but then, golf balls would be bouncing off my family and through the windows of my home. Sound familiar? Golf course residents that have paid handsomely for that front row view often find themselves one “Slice” away from damage or danger.
...
`,
    image: 'https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2019/08/03-Golf-Ball-Net-400.jpg',
    date: '2019-10-25',
    category: 'Uncategorized',
  },
  {
    slug: 'a-summary-of-mosquito-protection-ideas',
    title: 'A Summary Of Mosquito Protection Ideas. - Mosquito Curtains',
    excerpt: 'A front porch is like a warm embrace inviting visitors into the heart of the home. It is where we share a balmy evening dinner with friends, where a porch swing beckons a first kiss, or where a boy mi',
    content: `A front porch is like a warm embrace inviting visitors into the heart of the home. It is where we share a balmy evening dinner with friends, where a porch swing beckons a first kiss, or where a boy might share his sad day with a puppy. However, the peace is shattered when we hear that familiar high-pitched buzz of persistent mosquitoes. We’ve spent so much effort adorning our lovely open porches and when we refuse the eye-sore of permanent screening, we ask, “What else can we do to protect ourselves from the nasty blood suckers that hunt us?
...
`,
  ...
  {
    slug: 'lasting-effects-of-the-west-nile-virus',
    title: 'Lasting Effects of the West Nile Virus - Mosquito Curtains',
    excerpt: 'As we hear about West Nile Virus on the news, it is easy to become complacent. Since 2000, there have been over 40,000 reported cases more than 1,000 deaths. We read that the most susceptible are the ',
    content: `As we hear about West Nile Virus on the news, it is easy to become complacent. Since 2000, there have been over 40,000 reported cases more than 1,000 deaths. We read that the most susceptible are the elderly and young children, particularly those with weak immune systems. But, what is not fully appreciated is the lasting effects that this virus can have on those that are considered to be relatively healthy.
...
The Mosquito Curtain is very effective for protecting covered porch areas from mosquitoes. The netting material is made of a sturdy 100% polyester suitable for regular outdoor use. See: mosquitocurtains.kinsta.cloud
...
`,
  ...
  {
    slug: 'teaching-children-that-work-is-good',
    title: 'Teaching Children That “Work is Good" - Mosquito Curtains',
    excerpt: 'Every parent would like to raise their children to be happy productive adults. Considering that work comprises more than half of the adult waking day, wouldn’t it be nice if we could guide our childre',
    content: `Every parent would like to raise their children to be happy productive adults. Considering that work comprises more than half of the adult waking day, wouldn’t it be nice if we could guide our children to find fulfillment in their adult careers?
...
`,
  ...
  {
    slug: 'dear-martha-stewart',
    title: 'Dear Martha Stewart - Mosquito Curtains',
    excerpt: 'March 20, 2007',
    content: `March 20, 2007
...
`,
  ...
  {
    slug: 'a-very-cool-project-for-kids-theyll-remember-it-forever',
    title: 'A Very Cool Project For Kids (They\'ll Remember It Forever) - Mosquito Curtains',
    excerpt: 'If you grew up during the Great Depression, chances are you learned to make your own fun. Yet another wonderful quality of the Greatest Generation is that they learned to make just about anything out ',
    content: `If you grew up during the Great Depression, chances are you learned to make your own fun. Yet another wonderful quality of the Greatest Generation is that they learned to make just about anything out of scraps of whatever was available. The talent partially passed to the next generation, but has certainly faded now that our kids are consumed by video games and Sponge Bob.
...
`,
    image: 'https://www.mosquitocurtains.com/wp-content/uploads/2019/10/Cart-old-small-1.jpg',
    date: '2019-10-25',
    category: 'Uncategorized',
  },
  {
    slug: 'bond-sales-mosquito-curtains-and-a-rodeo-ghost',
    title: 'Bond Sales, Mosquito Curtains And A Rodeo Ghost. - Mosquito Curtains',
    excerpt: 'I should have been content with my coveted Wall Street job as a bond salesman, but after 19 years, I decided to recklessly toss tie to the wind for the life of a small business entrepreneur beckoned b',
    content: `I should have been content with my coveted Wall Street job as a bond salesman, but after 19 years, I decided to recklessly toss tie to the wind for the life of a small business entrepreneur beckoned by a ghost of the past. Some people are built for institutional bond sales and some are able to fake it for a very long time. I should have realized my lack of calling during the interview process. Towards the end of my first year at graduate business school at Berkeley in the mid-80’s, I was looking for a summer job and heard of a class trip to New York to visit the investment banking firms. The tour was an open house where we were able to spend a couple of hours at a half-dozen of the Wall Street firms. I knew practically nothing about “the business” and impulsively went along. I simply listened, watched and imitated.
...
There is something to be said about pointing to a physical product and proudly saying, “We made that,” rather than staring to a stack of trade tickets with a cocked head trying to rationalize how you contribute to society by facilitating market liquidity. Fortunately, the business has flourished and we now have 20 employees with over 90,000 orders under our belt since 2004.
...
As difficult as small business is though, I am forever pleased to have muscled through the fear to rally enough courage to listen to my grandfather and live for today and let tomorrow worry about itself. Never once have I looked back and regretted my decision. I am a round peg in a round hole now and it feels great. The grass may not always be greener but now it’s my lawn. Every day, I still think about my rodeo ghost, listen for guidance, and occasionally search for his fancy silver rodeo belt buckle that he must have saved for me.
...
Sport Jordan’s Silver Star

Jordan Kids

Sport Jordan With Oil Crew (lower left)

Sport Jordan (right)

1st POW ship Oryoku Maru bombedThe white dots are POWs swimming to shore

1 of 4 Post Cards Sent Home

BDA photo of the Enaura Maru2nd ship taken within seconds of his death

`,
    image: 'https://static.mosquitocurtains.com/wp-media-folder-mosquito-curtains/wp-content/uploads/2019/10/Sport-Jordan.jpg',
    date: '2019-10-25',
    category: 'Uncategorized',
  },
]
